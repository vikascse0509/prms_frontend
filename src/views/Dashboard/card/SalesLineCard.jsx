...
// Custom components
import PropertyAllocationVisual from '../Default/PropertyAllocationVisual';
      ...
      <CardContent sx={{ padding: 0, paddingBottom: '0 !important' }}>
        <Box bgcolor={bgColor ? bgColor : theme.palette.primary.main} p={3}>
          <Grid container direction="column" spacing={1}>
            ...
            {showPropertyVisual ? (
              <Grid item>
                <Box sx={{ bgcolor: '#fff', borderRadius: 1, mt: 2 }}>
                  <PropertyAllocationVisual totalProperties={totalProperties} allocatedProperties={allocatedProperties} />
                </Box>
              </Grid>
            ) : (
              chartData && (
...
SalesLineCard.propTypes = {
  ...
  title: PropTypes.string,
  percentage: PropTypes.string,
  showPropertyVisual: PropTypes.bool,
  totalProperties: PropTypes.number,
  allocatedProperties: PropTypes.number
};
